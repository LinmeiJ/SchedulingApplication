...
public class User {
    /**
     * An user ID that is generated by the database
     */
    private int user_id;
    /**
     * An user name that is associated to the user ID
     */
    private String user_name;
    /**
     * A password that is associated to the user
     */
    private String password;
    /**
     * The date time of when the user is created
     */
    private Date created_date;
    /**
     * The person who created this user
     */
    private String created_by;
    /**
     * The date time that the user was last updated
     */
    private Timestamp last_update;
    /**
     * The person who last updated this user
     */
