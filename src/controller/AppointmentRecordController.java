...
//            } else
     ...
     * Using stream to loop through a list, then save elements to a new list based on a filter condition.
     * There will be much more code involves if I use traditional way to operate the same task.
     *
